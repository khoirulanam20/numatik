            ...
            <div className="min-h-screen flex flex-col bg-gradient-to-b dark:from-blue-800 dark:to-gray-900 from-blue-400 to-gray-50">
                ...
                <main className="flex-grow container mx-auto px-4 py-8">
                    <div className="max-w-7xl mx-auto">
                        <h1 className="text-3xl font-bold mb-2 text-gray-800 dark:text-white">Konser</h1>
                        <p className="mb-6 text-gray-600 dark:text-gray-300">Informasi tentang Konser yang akan datang.</p>
                        ...
                        <div className="flex flex-col lg:flex-row gap-8">
                            ...
                            <div className="w-full lg:w-1/2">
                                {[
                                    { title: "Paket 1", description: "Nikmati penampilan band rock terbaik dalam satu malam yang epik!", price: "Rp 500.000" },
                                    { title: "Paket 2", description: "Rasakan alunan jazz yang menenangkan dari musisi terkenal.", price: "Rp 450.000" },
                                    { title: "Paket 3", description: "Saksikan penyanyi pop favorit Anda dalam Konser yang meriah!", price: "Rp 550.000" }
                                ].map((paket, index) => (
                            ...
                            <div className="w-full lg:w-1/2">
                                <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                                    <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-white">Pesan Tiket Konser</h2>
                                    {[
