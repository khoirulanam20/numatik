            ...
            <div className="min-h-screen flex flex-col">
                ...
                <main className="flex-grow">
                    <div className="container mx-auto px-4 py-8">
                        <h1 className="text-3xl font-bold mb-4">Pernikahan</h1>
                        <p className="mb-6">Informasi tentang Pernikahan yang akan datang.</p>
                        ...
                        <div className="flex flex-col md:flex-row gap-8">
                            ...
                            <div className="w-full md:w-1/2">
                                ...
                                <div className="mb-6 p-6 bg-white border border-gray-200 rounded-lg shadow">
                                    ...
                                    <p className="mb-3 text-gray-700">Saksikan penyanyi pop favorit Anda dalam Pernikahan yang meriah!</p>
